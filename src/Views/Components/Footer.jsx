const navigation = {
    ...
    social: [
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/adria.vallesbaradad/',
        icon: (props) => (
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/adriavallesbaradad/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
  ...
  export default function Example() {
    return (
      <footer className="flex flex-col  bg-gray-800">
        <div className=" max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
